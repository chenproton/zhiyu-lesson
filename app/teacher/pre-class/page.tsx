  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">课前：预习任务发布</h1>
          <p className="text-muted-foreground mt-1">发布预习微课、电子讲义、课前小测，自动统计预习数据</p>
        </div>
        <Link href="/teacher/pre-class/new">
          <Button><Plus className="h-4 w-4 mr-1" /> 发布预习任务</Button>
        </Link>
      </div>
