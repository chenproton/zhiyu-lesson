  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">期末：过程性考核</h1>
          <p className="text-muted-foreground mt-1">平台自动汇总观看时长、作业得分、测验得分、签到、互动等过程数据</p>
        </div>
        <Button><FileText className="h-4 w-4 mr-1" /> 生成考核报告</Button>
      </div>
