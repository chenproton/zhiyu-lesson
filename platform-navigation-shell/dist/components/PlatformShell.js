...
function PlatformSideNav({ config }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("aside", { className: "sticky top-14 flex h-[calc(100vh-3.5rem)] w-56 shrink-0 flex-col overflow-hidden border-r border-gray-100 bg-white", children: [(0, jsx_runtime_1.jsx)("div", { className: "border-b border-gray-100 p-4", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3", children: [(0, jsx_runtime_1.jsx)(link_1.default, { href: config.sideBackHref, className: "flex h-8 w-8 items-center justify-center rounded-lg bg-gray-50 transition-colors hover:bg-primary/10 hover:text-primary", children: (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronLeft, { className: "h-4 w-4" }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2", children: [(0, jsx_runtime_1.jsx)(PlatformIcon, { className: "h-4 w-4 text-primary" }), (0, jsx_runtime_1.jsx)("h2", { className: "text-sm font-medium text-gray-800", children: config.currentPlatformLabel })] })] }) }), (0, jsx_runtime_1.jsx)("nav", { className: "flex-1 p-3", children: config.sideNavItems.map((item) => {
                ...
                }) }), config.platformSwitchItems && config.platformSwitchItems.length > 0 && ((0, jsx_runtime_1.jsxs)("div", { className: "border-t border-gray-100 p-3", children: [(0, jsx_runtime_1.jsx)("p", { className: "mb-2 px-3 text-xs font-medium text-gray-400", children: "\u5E73\u53F0\u5207\u6362" }), (0, jsx_runtime_1.jsx)("div", { className: "space-y-1", children: config.platformSwitchItems.map((item) => {
                            const Icon = (0, icons_1.resolvePlatformIcon)(item.icon);
                            const active = (0, utils_1.matchesPath)(pathname, item.href, item.matchers);
                            return ((0, jsx_runtime_1.jsxs)(link_1.default, { href: item.href, className: (0, utils_1.cn)("flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm transition-colors", active
                                    ? "bg-primary/5 font-medium text-primary"
                                    : "text-gray-500 hover:bg-gray-50 hover:text-gray-800"), children: [(0, jsx_runtime_1.jsx)(Icon, { className: "h-4 w-4" }), item.label] }, item.id));
                        }) })] }))] }));
}
