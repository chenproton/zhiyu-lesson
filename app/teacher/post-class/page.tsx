  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">课后：作业测验与答疑</h1>
          <p className="text-muted-foreground mt-1">线上布置作业、单元测试、讨论题，AI自动批改客观题，全过程留学习数据</p>
        </div>
        <Link href="/teacher/post-class/new">
          <Button><Plus className="h-4 w-4 mr-1" /> 发布课后任务</Button>
        </Link>
      </div>
