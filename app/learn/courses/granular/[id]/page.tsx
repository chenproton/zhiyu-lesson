    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-6">
        ...
        <TabsList>
          ...
          <TabsTrigger value="catalog">课程目录</TabsTrigger>
                ...
                {Array.from({ length: course.nodeCount }).map((_, i) => (
                  <div key={i} className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-sm">{course.name} - 第{i + 1}节</p>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 rounded-lg bg-blue-50 border border-blue-100">
                ...
                <p className="text-sm text-blue-800/80 leading-relaxed">
                  掌握{course.name}的基本概念、核心原理与关键技术。
                </p>
              </div>
              <div className="p-4 rounded-lg bg-green-50 border border-green-100">
                ...
                <p className="text-sm text-green-800/80 leading-relaxed">
                  能够运用所学知识分析与解决实际问题，具备独立完成相关任务的能力。
                </p>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {["SQL注入", "漏洞检测", "渗透测试", "Web安全", "安全防护"].map((kp) => (
            ...
            <CardContent className="space-y-4">
              <div className="p-4 rounded-lg border border-blue-100 bg-blue-50/50">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="text-sm font-semibold text-gray-800">单元测验</h4>
                  <Badge variant="outline" className="text-xs">5 题 · 50 分</Badge>
                </div>
                <div className="space-y-2">
                  <div className="flex items-start gap-2 p-2 rounded bg-white border border-gray-100">
                    <span className="px-1.5 py-0.5 text-[10px] bg-blue-50 text-blue-500 rounded shrink-0 mt-0.5">单选</span>
                    <p className="text-sm text-gray-700">1. SQL注入的主要攻击方式包括？</p>
                  </div>
                  <div className="flex items-start gap-2 p-2 rounded bg-white border border-gray-100">
                    <span className="px-1.5 py-0.5 text-[10px] bg-purple-50 text-purple-500 rounded shrink-0 mt-0.5">简答</span>
                    <p className="text-sm text-gray-700">2. 请简述防御SQL注入的常用方法。</p>
                  </div>
                </div>
              </div>
            </CardContent>
